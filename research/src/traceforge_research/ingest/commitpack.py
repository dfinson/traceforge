...
traceforge titler must learn (context -> short imperative summary), and it is
...
serve-side :func:`~traceforge.title.context.distilled_context` is recomputed from
...
Never re-ingest labelled traceforge sessions: commitpackft is a **new** source
