"""Composable labeling framework for traceforge-research.
...
Concrete tasks live under ``traceforge_research.labeling.tasks``.
Concrete backends live under ``traceforge_research.labeling.backends``.
"""
