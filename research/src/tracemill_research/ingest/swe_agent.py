"""Ingest nebius/SWE-agent-trajectories into tracemill enriched parquets.
...
All events flow through tracemill's :class:`~tracemill.enricher.Enricher`
and :class:`~tracemill.sinks.parquet.ParquetSink` so the on-disk schema
