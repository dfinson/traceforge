...
from tracemill.phase.segmentation import SegmentationParams, session_segmentation_features
...
class GapExample:
    ...
    Field names mirror :class:`tracemill.phase.features.EventExample` so the
...
def featurize_session_gaps(
    ...
    :func:`tracemill.phase.event_rows.event_to_feature_row`). Returns one
