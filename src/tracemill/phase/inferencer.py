...
class PhaseInferencer:
    ...
    :func:`tracemill.phase.inference.resolve_model_path` (env var / packaged
    ...
    def predict(self, events: Sequence[SessionEvent]) -> list[dict]:
        ...
        :func:`tracemill.phase.inference.predict_examples`.
        """
...
class SessionPhaseStream:
    ...
    Drives :class:`~tracemill.phase.features.StreamingSessionFeaturizer` so each
