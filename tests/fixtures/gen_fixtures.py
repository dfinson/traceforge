...
copilot_lines = [
    ...
    },
    {
        ...
        "data": {"content": "Create a hello world function in Python"},
    },
    {
        "type": "assistant.turn_start",
        "id": uid(),
        "timestamp": "2024-06-01T10:00:06Z",
        "data": {"turnId": "turn-1", "interactionId": "int-1"},
    },
    {
        "type": "assistant.message",
        "id": uid(),
        "timestamp": "2024-06-01T10:00:07Z",
        "data": {"messageId": "msg-1", "content": "I will create a hello world function for you."},
    },
    {
    ...
    },
    {
        ...
        "data": {
            "toolCallId": "tc-0001",
            "success": True,
            "result": {"content": "File created: hello.py", "detailedContent": None},
        },
    },
    {
        "type": "tool.execution_start",
        ...
        "data": {"toolCallId": "tc-0002", "toolName": "powershell", "arguments": "python hello.py"},
    },
    {
        "type": "tool.execution_complete",
        "id": uid(),
        "timestamp": "2024-06-01T10:00:11Z",
        "data": {
            "toolCallId": "tc-0002",
            "success": True,
            "result": {"content": "Hello, world!", "detailedContent": None},
        },
    },
    {
        "type": "assistant.message",
        ...
        "data": {
            "messageId": "msg-2",
            "content": "Done! I created hello.py and verified it works.",
        },
    },
    {
        "type": "assistant.turn_end",
        "id": uid(),
        "timestamp": "2024-06-01T10:00:13Z",
        "data": {"turnId": "turn-1"},
    },
    {
    ...
    },
    {
        "type": "hook.start",
        "id": uid(),
        "timestamp": "2024-06-01T10:00:14Z",
        "data": {"hookInvocationId": "hook-1", "hookType": "pre-commit"},
    },
    {
        "type": "hook.end",
        "id": uid(),
        "timestamp": "2024-06-01T10:00:15Z",
        "data": {"hookInvocationId": "hook-1", "hookType": "pre-commit", "success": True},
    },
    {
        "type": "session.info",
        "id": uid(),
        "timestamp": "2024-06-01T10:00:16Z",
        "data": {"infoType": "notification", "message": "Session saved"},
    },
    {
        "type": "session.shutdown",
        "id": uid(),
        "timestamp": "2024-06-01T10:00:17Z",
        "data": {
            "shutdownType": "routine",
            "totalPremiumRequests": 3,
            "totalApiDurationMs": 3500,
            "codeChanges": {"filesModified": ["hello.py"], "linesAdded": 2, "linesRemoved": 0},
            "modelMetrics": {},
...
claude_lines = [
    {
        "type": "user",
        "message": {"content": "Read the contents of main.py and fix any bugs"},
    ...
    },
    {
        ...
        "message": {
            "content": [
                {"type": "text", "text": "I'll read main.py first to check for bugs."},
                {
                    "type": "tool_use",
                    "id": "tu-1",
                    "name": "read_file",
    ...
    },
    {
        ...
        "message": {
            "content": [
                {
                    "type": "text",
                    "text": "I found a bug: the add function subtracts instead of adding. Let me fix it.",
                },
                {
                    "type": "tool_use",
                    "id": "tu-2",
    ...
    },
    {
        ...
        "message": {
            "content": [
                {
                    "type": "text",
                    "text": "I've fixed the bug in main.py. The add function was using subtraction (-) instead of addition (+).",
                }
            ],
            "model": "claude-sonnet-4-20250514",
        },
    ...
    {
        "type": "user",
        "message": {"content": "Thanks, run the tests now"},
        "cwd": "/home/user/project",
        "sessionId": "claude-sess-456",
    },
    {
    ...
    },
    {
        ...
        "message": {
            "content": [
                {"type": "thinking", "thinking": "The tests all pass now.", "signature": "sig123"},
                {"type": "text", "text": "All 3 tests pass. The fix is working correctly."},
            ],
            "model": "claude-sonnet-4-20250514",
        },
    },
